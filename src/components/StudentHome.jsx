          ...
          <div ref={menuRef2}>
            ...
            <div className={`menu-1-dropdown ${open2 ? "active" : "inactive"}`}>
              <div className="custom-h5 d-flex flex-column align-items-end">
                <Link to={"/profile"} className="text-black">ข้อมูลส่วนตัว</Link>
                <Link to={"/usermanagement"} className="text-black">จัดการข้อมูลผู้ใช้</Link>
                <Link to={"/student-table-management"} className="text-black">จัดการตารางเรียน</Link>
                <Link to={"/teacher-table-management"} className="text-black">จัดการตารางสอน</Link>
              </div>
            </div>
          </div>
          ...
          <div ref={menuRef3}>
            ...
            >
              <div className="custom-h5">
                <Link to="/school-record-management" className="text-black">จัดการผลการเรียน</Link>
              </div>
            </div>
          </div>
